...
class SchedularRepositoryTest {
    ...
    void testCreateAndFind() {
        Schedule saved = schedularRepository.save(createSampleSchedule("테스트 일정"));
        Optional<Schedule> found = schedularRepository.findById(saved.getId());
    ...
    void testUpdate() {
        Schedule schedular = schedularRepository.save(createSampleSchedule("원본 일정"));
        schedular.setTitle("수정된 일정");
        Schedule updated = schedularRepository.save(schedular);
    ...
    void testDelete() {
        Schedule schedular = schedularRepository.save(createSampleSchedule("삭제 일정"));
    ...
    void testFindAll() {
        ...
        List<Schedule> schedules = schedularRepository.findAll();
