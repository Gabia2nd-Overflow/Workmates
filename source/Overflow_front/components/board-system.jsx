...
import { Plus, Search, Filter, TrendingUp, MessageSquare, Heart, Eye, Clock, Zap } from "lucide-react"
  ...
  const posts = [
    {
      ...
      content: "클라이언트 요구사항을 반영한 새로운 웹사이트 프로젝트 기획안입니다. 팀원들의 의견을 듣고 싶습니다.",
      author: "김철수",
      ...
      comments: 8,
      likes: 12,
      aiSummary: "긍정적인 반응이 많은 기획안으로, 실현 가능성이 높다고 분석됩니다.",
    },
    {
      id: 2,
      title: "디자인 시스템 업데이트 관련 논의",
      content: "현재 사용 중인 디자인 시스템의 문제점과 개선 방안에 대해 논의하고 싶습니다.",
      author: "이영희",
      avatar: "/placeholder.svg?height=32&width=32",
      time: "4시간 전",
      category: "디자인",
      ...
      comments: 15,
      likes: 8,
      aiSummary: "건설적인 의견들이 많으며, 구체적인 개선 방안이 제시되고 있습니다.",
    },
    {
      id: 3,
      title: "마케팅 캠페인 성과 분석",
      content: "지난 달 진행한 마케팅 캠페인의 성과를 분석하고 다음 전략을 수립해보겠습니다.",
      author: "박민수",
      avatar: "/placeholder.svg?height=32&width=32",
      time: "6시간 전",
      category: "마케팅",
      ...
      comments: 22,
      likes: 18,
      aiSummary: "성과에 대한 긍정적 평가가 주를 이루며, 확장 전략에 대한 관심이 높습니다.",
    },
  ]
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-blue-600 mt-1">AI 감성 분석과 요약이 지원되는 협업 게시판</p>
        </div>
            ...
            <Card key={post.id} className="hover:shadow-md transition-shadow">
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={`${getSentimentColor(post.sentiment)} flex items-center space-x-1`}>
              ...
              <CardContent>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-blue-800">AI 감성 분석 요약</span>
                  </div>
